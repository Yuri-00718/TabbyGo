...
class JudgingHistoryPage extends StatefulWidget {
  const JudgingHistoryPage({super.key});

  @override
  _JudgingHistoryPageState createState() => _JudgingHistoryPageState();
}

class _JudgingHistoryPageState extends State<JudgingHistoryPage> {
